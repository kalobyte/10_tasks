<?php
$filters = array(
    'reports'=> array("attr" => "reports file", "data" => "rrrReports"),
    'analytics' => array("attr" => "analytics graphs", "data" => "Analytics"),
    'export' =>  array("attr" => "export download", "data" => "Export"),
    'storage' => array("attr" => "storage", "data" => "Storage")
);
?>
                                    ...
                                    <ul id="js-list-msg" class="list-group px-2 pb-2 js-list-filter">
                                        <?php foreach($filters as $filter): ?>
                                            <li class="list-group-item">
                                                <span data-filter-tags="<?php echo $filter['attr'];?>"><?php echo $filter['data'];?></span>
                                            </li>
                                        <?php endforeach ?>
                                    </ul>
