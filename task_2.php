...
$article = array(
    "article" => array(
    "h2" => "Privacy",
    "text1" => "  Your privacy is important to us at SmartAdmin and the protection, confidentiality and integrity of your personal data are our prime concerns.
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                                <?php foreach($article as $elements): ?>
                                    <h2><?php echo $elements['h2']; ?></h2>
                                    <p class="mb-g">
                                        <?php echo $elements['text1']; ?>
                                    </p>
                                    <h3><?php echo $elements['h3']; ?></h3>
                                    <p>
                                        <?php echo $elements['text2']; ?>
                                    </p>
                                <?php endforeach ?>
                        </div>
                        </div>
